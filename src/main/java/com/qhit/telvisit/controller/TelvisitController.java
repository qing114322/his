...
public class TelvisitController { 
    ...
    public String insert(Telvisit telvisit,Model model) {
        telvisitService.insert(telvisit);
        model.addAttribute("cid",telvisit.getCid());
    ...
    @RequestMapping("/listcid")
    public String listcid(Telvisit telvisit ,Model model) throws IOException {
        System.out.println(telvisit.getCid());
       List<Telvisit>list= telvisitService.findBycid(telvisit.getCid());
        model.addAttribute("list",list);
        return "telvisit/list";
    }
